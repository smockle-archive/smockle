...
class HomeController < ApplicationController
  ...
  def index
    ...
    @image = HTTParty.get("https://api.instagram.com/v1/users/self/media/recent?access_token=" + Figaro.env.IGRAM_ACCESS_TOKEN)["data"].reject{|i| i["tags"].include? "p"}.first["images"]["standard_resolution"]["url"]
  end
